...
const Hirecaregivers = () => {
 

  return (
    <section id='hcaregivers' class='relative  isolate overflow-hidden items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols lg:px-6 sm:py-32 drop-up'>  <div className=' flex flex-col items-center' >
        <div>
          ...
          <Button text='Get Started' navigate='/carerecieverreg'/>
