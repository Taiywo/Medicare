...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        //             navigate("/Client/src/Dashboard.jsx");
    ...
    return (
        <section className="bg-image  dark:bg-gray-900" id='login'>
            <div className="flex flex-col items-center justify-center px-6 mt-[5rem]  py-32 pt-20  mx-auto md:h-screen lg:py-0">
