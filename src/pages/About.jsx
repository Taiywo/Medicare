...
// const About = () => {
//   return (
//     <section class="bg-white dark:bg-gray-900 sm:py-32">
...
//           <p class="mb-4 font-Poppins text-sm  md:text-xl lg:text-xl "> We understand that finding the right caregiver or care recipient is a vital step in ensuring a harmonious caregiving journey.
//             Our platform is designed to make this process seamless, personalized, and fulfilling.</p>
//           <p class="pt-4 font-Poppins text-sm  md:text-xl lg:text-xl ">  At Medi-care, our mission is to enrich lives by facilitating genuine connections between caregivers and care recipients.
